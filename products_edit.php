 ...
 <?php        
                ...
                echo '<table class="table table-hover"';
                  ...
                  echo "<tr>";
					...
					echo "<td><a href='products_edit_form.php?ID=$row[0]' class='btn btn-danger'><i class='fas fa-pen-square'></i> แก้ไขสินค้า</a></td>";
					echo "<td><a href='product_pic_form_edit.php?ID=$row[0]' class='btn btn-danger'><i class='fas fa-pen-square'></i> แก้ไขรูปภาพสินค้า</a></td>";					
					echo"</tr>";                  }
                echo "</table>";
                //5. close connection
                mysqli_close($con);
